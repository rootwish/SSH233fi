...
<body>
		...
		<div class="logoline">
			<div class="comWidth">
				...
				<s:form action="searchingProductAction" method="post" namespace="/">
					<input type="text" name="keyword" class="search-text fl">
					<input type="submit" value="搜 索" class="search-button fr" >
					</s:form>
				</div>
		...
		<div class="fr" style="width:810px">
			...
			<div class="products_list clearfix" >
				...
				<s:iterator value="#application.product">	
					<div class="item_img">
							<img src='images/<s:property value="smallImg"/>' alt='<s:property value="productName"/>'/>
						</div>
					...
					<span class="old_price">市场价：￥<s:property value="price"/></span>
				</s:iterator>				
				</div>
				--><div class="item">
					<div class="item_content">
