...
.title{
	...
	<body>
		<div class="header">
			<p class="title">填写产品信息</p>
			<div class="loginBox">
				<form action="" method="post" namespace="/">
					<span class="l_tit">产品代号:</span>
					<br />
					<input type="text" name="" class="login_input" id="" onblur=""
						onfocus="">
					<br />
					<span class="l_tit">产品名称:</span>
					<input type="text" name="" class="login_input" id="" onblur=""
						onfocus="">
					<br />
					<span class="l_tit">产品描述:</span>
					<textarea rows="6" cols="40" name="" style="border:1px solid #ccc"></textarea>
					<br />
					<span class="l_tit">价格:</span>
					<input type="text" name="" class="login_input" id="" onblur=""
						onfocus="">
					<br />
					<br/>
					<span class="l_tit">图片:</span>
