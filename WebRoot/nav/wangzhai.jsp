			...
			<div class="comWidth">
				...
				<div class="nav fl">
					<ul id="nav">
						...
						<li><a href="nav/wangzai.jsp">旺仔</a></li>
			...
			<div class="products_list clearfix" >
				<div class="item">
					<div class="item_content">
						<div class="item_img">
							<a href="#"><img src="shops/3001.jpg" /></a>
						</div>
						<p><a href="#">
旺仔 小馒头 牛奶味 210g/袋 粒粒营养丰富</a></p>
						<p class="money">￥8</p>
				...
				<div class="item">
					<div class="item_content">
						<div class="item_img">
							<a href="#"><img src="shops/3002.jpg" ></a>
						</div>
						<p><a href="#">
旺仔 小馒头 经典原味 210g/罐 零食小吃</a></p>
						<p class="money">￥15</p>
						<p>评论：<span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span></p>
					</div>
				</div>
				<div class="item">
					<div class="item_content">
						<div class="item_img">
							<a href="#"><img src="shops/3003.jpg"></a>
						</div>
						<p><a href="#">
旺仔 牛奶(原味礼盒装)125ml/盒*20 儿童牛奶整箱 早餐奶纯牛奶</a></p>
						<p class="money">￥45</p>
						<p>评论：<span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span></p>
					</div>
				</div>
				<div class="item">
					<div class="item_content">
						<div class="item_img">
							<a href="#"><img src="shops/3004.jpg"></a>
						</div>
						<p><a href="#">
旺仔 水蜜桃味QQ糖 70g 食品零食</a></p>
						<p class="money">￥3</p>
						<p>评论：<span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span></p>
					</div>
				</div>
				<div class="item">
					<div class="item_content">
						<div class="item_img">
							<a href="#"><img src="shops/3005.jpg" ></a>
						</div>
						<p><a href="#">旺旺 厚烧海苔 米制品 118g/袋 辣味休闲零食</a></p>
						<p class="money">￥7</p>
						<p>评论：<span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span></p>
					</div>
				</div>
				<div class="item">
					<div class="item_content">
						<div class="item_img">
							<a href="#"><img src="shops/3006.jpg" ></a>
						</div>
						<p><a href="#">旺旺 芝士仙贝 84g/袋 休闲零食 下午茶
</a></p>
						<p class="money">￥9</p>
						<p>评论：<span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span></p>
					</div>
				...
				<div class="item">
					<div class="item_content">
						<div class="item_img">
							<a href="#"><img src="shops/3007.jpg" ></a>
						</div>
						<p><a href="#">旺旺 泡芙 巧克力味 60g/盒 零食 下午茶
</a></p>
						<p class="money">￥9</p>
						<p>评论：<span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span></p>
					</div>
				...
				<div class="item">
					<div class="item_content">
						<div class="item_img">
							<a href="#"><img src="shops/3008.jpg" ></a>
						</div>
						<p><a href="#">旺旺 O泡果奶礼盒 125ml*20/盒草莓味 夏季解渴冰镇学生奶饮料
</a></p>
						<p class="money">￥65</p>
						<p>评论：<span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span></p>
					</div>
