			...
			<div class="products_list clearfix" >
				<div class="item">
					<div class="item_content">
						<div class="item_img">
							<a href="#"><img src="shops/1001.jpg" /></a>
						</div>
						<p><a href="#">三只松鼠 碧根果210gx2袋零食坚果炒货山核桃长寿果干果奶油味</a></p>
						<p class="money">￥33</p>
				...
				<div class="item">
					<div class="item_content">
						<div class="item_img">
							<a href="#"><img src="shops/1002.jpg" ></a>
						</div>
						<p><a href="#">三只松鼠 新货开口松子218gx2袋 东北红松子原味</a></p>
						<p class="money">￥42</p>
						<p>评论：<span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span></p>
					</div>
				</div>
				<div class="item">
					<div class="item_content">
						<div class="item_img">
							<a href="#"><img src="shops/1003.jpg"></a>
						</div>
						<p><a href="#">三只松鼠 夏威夷果265gx2袋零食坚果炒货干果奶油味</a></p>
						<p class="money">￥44</p>
						<p>评论：<span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span></p>
					</div>
				</div>
				<div class="item">
					<div class="item_content">
						<div class="item_img">
							<a href="#"><img src="shops/1004.jpg"></a>
						</div>
						<p><a href="#">三只松鼠 新货炭烧腰果185gx2袋 特产腰果仁</a></p>
						<p class="money">￥32</p>
						<p>评论：<span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span></p>
					</div>
				</div>
				<div class="item">
					<div class="item_content">
						<div class="item_img">
							<a href="#"><img src="shops/1005.jpg" ></a>
						</div>
						<p><a href="#">三只松鼠 手剥巴旦木235gx2袋零食坚果炒货特产干果巴达木</a></p>
						<p class="money">￥33</p>
						<p>评论：<span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span><span class="start"></span></p>
					</div>
				</div>
				<div class="item">
					<div class="item_content">
						<div class="item_img">
							<a href="#"><img src="shops/1006.jpg" ></a>
						</div>
						<p><a href="#">三只松鼠 纸皮核桃210gx2袋坚果炒货特产薄皮核桃原味</a></p>
